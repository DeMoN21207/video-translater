...
Для запуска графического приложения на базе Tkinter выполните:

```bash
python desktop_app.py
```

Интерфейс позволяет выбрать файл, задать папку сохранения, режим ускорения, размер модели и формат диалогов. После завершения транскрибации результат можно сохранить в текстовый файл прямо из окна приложения.
